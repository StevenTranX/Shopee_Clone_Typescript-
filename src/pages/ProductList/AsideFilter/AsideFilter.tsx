    ...
    <div className='py-4'>
      ...
      <div className='my-5'>
        ...
        <form action='' className='mt-2'>
          ...
          <Button className='py-2 px-2 w-full uppercase bg-orange text-white text-sm hover:bg-orange/80 flex justify-center items-center'>
            Áp dụng
          </Button>
        </form>
      </div>
      ...
      <div className='bg-gray-30 h-[1px] my-4'></div>
      <Button className='py-2 px-2 w-full uppercase bg-orange text-white text-sm hover:bg-orange/80 flex justify-center items-center'>
        Xóa tất cả
      </Button>
    </div>
